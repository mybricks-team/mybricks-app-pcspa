export default {
    react: [
        ...
        {
            name: 'render-web',
            path: '/public/render-web/1.2.58/index.min.js',
            CDN: "//f2.beckwai.com/kos/nlav12333/mybricks/render-web/1.2.58/index.min.js",
        },
        {
            name: 'plugin-http-connector',
        ...
        {
            name: "mybricks-plugin-connector-domain",
