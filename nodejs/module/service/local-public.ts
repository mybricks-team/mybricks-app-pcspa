...
export default {
  react: [
    ...
    {
      tag: "script",
      path: "public/render-web/1.2.10/index.min.js",
      CDN: "//f2.beckwai.com/kos/nlav12333/mybricks/render-web/1.2.10/index.min.js",
    },
  ],
  vue2: [
    {
    ...
    {
      tag: "script",
      path: "public/render-web-vue2/0.0.2/index.umd.js",
