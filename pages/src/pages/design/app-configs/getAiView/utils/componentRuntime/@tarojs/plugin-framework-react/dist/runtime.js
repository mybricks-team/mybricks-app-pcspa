...
function createReactApp(App, react, dom, config) {
    ...
    function renderReactRoot() {
        ...
        console.log('[renderReactRoot container]', container)
        if (container == null) {
    ...
    class AppWrapper extends react.Component {
        ...
        render() {
            ...
            // [MyBricks.ai]
            return h$1(App, { ...props, _standalone: true }, process.env.TARO_PLATFORM === 'web' ? h$1(Fragment !== null && Fragment !== void 0 ? Fragment : 'div', null, elements.slice()) : elements.slice());
        }
    }
    if (process.env.TARO_PLATFORM !== 'web') {
        renderReactRoot();
