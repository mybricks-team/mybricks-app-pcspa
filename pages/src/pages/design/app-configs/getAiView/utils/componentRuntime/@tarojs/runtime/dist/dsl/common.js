...
import { raf as _raf } from '@tarojs/runtime/dist/bom/raf.js';
import { taroWindowProvider } from '@tarojs/runtime/dist/bom/window.js';
import { PAGE_INIT, OPTIONS, EXTERNAL_CLASSES, BEHAVIORS, CONTEXT_ACTIONS, VIEW, ON_HIDE, ON_READY, ON_SHOW, ON_LOAD, CUSTOM_WRAPPER } from '@tarojs/runtime/dist/constants/index.js';
import { Current } from '@tarojs/runtime/dist/current.js';
import { eventHandler } from '@tarojs/runtime/dist/dom/event.js';
import { eventCenter } from '@tarojs/runtime/dist/emitter/emitter.js';
import env from '@tarojs/runtime/dist/env.js';
import { perf } from '@tarojs/runtime/dist/perf.js';
import { incrementId, customWrapperCache } from '@tarojs/runtime/dist/utils/index.js';
import { addLeadingSlash } from '@tarojs/runtime/dist/utils/router.js';
